...
These packages should be installed automatically when installing birdnetprocess from GitHub or from source (assuming they are listed in the DESCRIPTION under Imports).
