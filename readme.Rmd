...
By default, trends are plotted by the hour. However, you can use the `unit` parameter to aggregate detections into any time interval supported by `lubridate` (e.g., `"10 min"`, `"30 min"`, `"3 hours"`). This is useful for high-resolution activity analysis.
